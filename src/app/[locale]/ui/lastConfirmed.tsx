...
function DashboardLastConfirmed({ userInvitationList, extraction, t }: userInvitationList) {
    ...
    return (
        <div className='general-containeras'>
            ...
            <h2>{t("lastAttendees")}</h2>
            {
                confirmedUsers.length === 0 ? (
                    <div className='containerLast-Confirmed'>
                        <p>{t("noAttendeesYet")}</p>
                    </div>
                )
